...
当提示词、模型配置、二进制输出和元数据需要在大量数据行中保持对齐时，文生图就成了数据处理流程问题。本教程沿着 [`examples/image_generation.py`](https://github.com/AstroVela/vane/blob/v0.1.0/examples/image_generation.py)，使用 Vane 批量 UDF 构建这条处理流程。
...
完整 UDF 构造器、样例提示词生成、文件命名与全部运行参数请查看 [0.1.0 完整源码](https://github.com/AstroVela/vane/blob/v0.1.0/examples/image_generation.py)。
