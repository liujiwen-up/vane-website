...
See the [complete 0.1.0 source](https://github.com/AstroVela/vane/blob/v0.1.0/examples/image_generation.py) for the full UDF constructor, sample prompt generation, file naming, and all runtime arguments.
